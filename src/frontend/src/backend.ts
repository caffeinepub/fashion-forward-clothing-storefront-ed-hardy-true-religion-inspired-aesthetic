...
export class Backend implements backendInterface {
    ...
    async getProducts(arg0: bigint | null, arg1: string | null): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProducts(to_candid_opt_n4(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n5(this._uploadFile, this._downloadFile, arg1));
...
function from_candid_record_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        collection: record_opt_to_undefined(from_candid_opt_n3(_uploadFile, _downloadFile, value.collection)),
        name: value.name,
        tags: value.tags,
